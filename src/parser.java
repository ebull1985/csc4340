...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Mar 26 17:03:11 EDT 2017
  */
		 ...
		 SQLNode sqlNode = new SQLNode(o, s, r);
            for(Column col : s) {
                ...
                if(matchCount == 0) {
                    ...
                    semantics.add("Ambiguous Column Reference: " + aName);
                }
            }
                ...
                for(String[] tnames : r) {
                    ...
                    if(db.relationExists(tname)) {
                        ...
                        if(db.getRelation(tname).attributeExists(whereCol.getName())) {
                            ...
                            } else if (!whereCol.getPrefix().equals(tname)) {
                                semantics.add("Ambiguous Column Reference: " + whereCol.getName());
                            }
                        }
                    } else {
                        semantics.add("Table does not exist: " + tname);
		  ...
		  System.out.println("No Syntax Error");
            ...
            for(Column checkColumn : ColTypeAssertions.keySet()) {
                ...
                if(!checkType.equals(ColTypeAssertions.get(checkColumn))) {
                    throw new SemanticException("Type mismatch. " + checkColumn.getName() + " is not type " + checkType + ".");
                }
            }
            //Column to Column
