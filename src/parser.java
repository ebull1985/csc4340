...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Mar 25 13:57:10 EDT 2017
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\041\000\002\007\004\000\002\002\004\000\002\010" +
    "\007\000\002\012\002\000\002\012\003\000\002\011\003" +
    "\000\002\011\005\000\002\013\003\000\002\013\005\000" +
    "\002\014\004\000\002\015\003\000\002\015\005\000\002" +
    "\016\003\000\002\016\004\000\002\017\003\000\002\020" +
    ...
    "\025\003\000\002\002\005\000\002\003\003\000\002\003" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\065\000\006\007\003\010\004\001\001\000\002\001" +
    "\001\000\002\001\001\000\004\012\007\001\001\000\002" +
    "\001\001\000\006\011\010\013\012\001\001\000\004\014" +
    "\017\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\004\013\064\001\001\000" +
    "\010\015\057\016\056\017\054\001\001\000\006\021\022" +
    "\022\020\001\001\000\002\001\001\000\024\002\032\003" +
    "\031\004\033\005\025\006\030\013\024\023\037\024\036" +
    "\025\023\001\001\000\002\001\001\000\002\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\002\001\001\000\002\001" +
    "\001\000\002\001\001\000\020\002\032\003\031\004\033" +
    "\005\025\006\030\013\024\025\042\001\001\000\002\001" +
    "\001\000\002\001\001\000\002\001\001\000\022\002\032" +
    "\003\031\004\033\005\025\006\030\013\024\024\041\025" +
    "\023\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\010\003\045\004\033\013\024\001\001\000" +
    ...
    "\061\017\054\001\001\000\002\001\001\000\002\001\001" +
      ...
      switch (CUP$parser$act_num)
        {
          ...
          case 32: // exists_pred ::= EXISTS LPAREN select_stmt RPAREN 
            {
              Object RESULT =null;
		  RESULT = true; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("exists_pred",4, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          ...
          case 31: // in_pred ::= scalar_exp IN LPAREN select_stmt RPAREN 
            {
              Object RESULT =null;
		  RESULT = true; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("in_pred",3, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 28: // scalar_exp ::= column_ref 
            {
              Object RESULT =null;
		  RESULT = true; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("scalar_exp",1, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 26: // comparison_pred ::= scalar_exp COMPARISON scalar_exp 
            {
              Object RESULT =null;
		  RESULT = true; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("comparison_pred",0, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		  ...
		  RESULT = new WhereNode(); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("pred",19, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		WhereNode p = (WhereNode)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 WhereNode whereNode = p;
            p.setNegated();
            RESULT = p; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("predicate",18, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		WhereNode p = (WhereNode)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = p; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("predicate",18, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		WhereNode p = (WhereNode)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ArrayList<WhereNode> whereNodes = wns;
            wns.add(p); 
            RESULT = whereNodes; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("search_condition",17, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		WhereNode p = (WhereNode)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ArrayList<WhereNode> whereNodes = new ArrayList<WhereNode>();
            whereNodes.add(p); 
            RESULT = whereNodes; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("search_condition",17, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		ArrayList<WhereNode> wns = (ArrayList<WhereNode>)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		  RESULT = wns; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("where_clause",16, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		ArrayList<WhereNode> wns = (ArrayList<WhereNode>)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		  RESULT = wns; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("opt_where_clause",15, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String n = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		  RESULT = n; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("tableAlias",14, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String n = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		  RESULT = n; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("table",13, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String a = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		  String[] tref = new String[2];
            ...
            tref[1] = new String(a);
            RESULT = tref; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("table_ref",12, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String t = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 String[] tref = new String[2];
            ...
            tref[1] = null;
            RESULT = tref; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("table_ref",12, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String[] t = (String[])((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ArrayList<String[]> tables = ts;
            tables.add(t);
            RESULT = tables; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("table_ref_commalist",11, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String[] t = (String[])((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ArrayList<String[]> tables = new ArrayList<String[]>();
            tables.add(t);
            RESULT = tables; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("table_ref_commalist",11, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String n = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		  RESULT = new Column(p, n); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("column_ref",9, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String n = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 RESULT = new Column(n); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("column_ref",9, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		Column c = (Column)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ArrayList<Column> cols = s;
            cols.add(c);
            RESULT = cols; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("select_list",7, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		Column c = (Column)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ArrayList<Column> cols = new ArrayList<Column>();
            cols.add(c);
            RESULT = cols; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("select_list",7, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 4: // opt_distinct ::= DISTINCT 
            {
              Boolean RESULT =null;
		 RESULT = true; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("opt_distinct",8, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		ArrayList<WhereNode> owc = (ArrayList<WhereNode>)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 SQLNode sqlNode = new SQLNode(o, s, r);
            if(owc != null) sqlNode.setWhereNodes(owc);
            System.out.println(sqlNode.toString());
            RESULT = sqlNode; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("select_stmt",6, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		SQLNode s = (SQLNode)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		  System.out.println("\nNo Syntax Error\n");
            ...
            RESULT = sqlNode; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("sql_start",5, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
