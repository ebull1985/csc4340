...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Apr 15 15:21:40 EDT 2017
  */
		 ...
		 System.out.println("No Syntax Error");
			...
			if (unmatchedCols.size() > 0) {
				for (Column unmatchedCol : unmatchedCols.keySet()) {
					...
					semantics.add(String.format("Unmatched Column : %s.%s from %s", unmatchedPrefix, unmatchedName, String.join(", ", fromStrings)));
				}
			}
            if(semantics.size() > 0) {
